...
const tarifs = [
  { group: 'Acide Hyaluronique', items: [
    { soin: 'Acide Hyaluronique', prix: '360€ TTC / seringue (1ml)', details: "Variable selon la zone et l'indication" },
  ]},
  { group: 'Peelings Médicaux', items: [
    { soin: 'Peeling glycolique', prix: '120€ TTC', details: '' },
    { soin: 'Peeling TCA', prix: '480€ TTC', details: '' },
    { soin: 'Peeling dépigmentant', prix: '180€ TTC', details: '' },
  ]},
  { group: 'Microneedling avec Radiofréquence', items: [
    { soin: 'Microneedling avec Radiofréquence', prix: '240€ TTC / séance', details: 'Visage complet' },
  ]},
  { group: 'Botox', items: [
  ...
  { group: 'HIFU (Ultrasons Focalisés)', items: [
    ...
    { soin: 'Visage complet', prix: '1080€ TTC', details: '' },
    { soin: 'Cou', prix: '480€ TTC', details: '' },
    { soin: 'Pourtour de la bouche', prix: '360€ TTC', details: '' },
    { soin: 'Paupières et poches malaires', prix: '360€ TTC', details: '' },
    { soin: 'Visage complet + cou', prix: '1320€ TTC', details: '' },
    { soin: 'Zone du corps (ex: bras, ventre, intérieur des cuisses)', prix: 'à partir de 960€ TTC', details: '' },
  ]},
  { group: 'EMSlim NEO', items: [
    { soin: 'EMSlim NEO', prix: '130€ TTC / séance (30 min)', details: '' },
  ]},
  { group: 'Coussin pelvien EMSLIM RF', items: [
    { soin: 'Coussin pelvien EMSLIM RF', prix: '180€ TTC / séance', details: '' },
  ]},
  { group: 'Épilation Définitive au Laser', items: [
    { soin: 'Lèvres', prix: '60€ TTC', details: '' },
    { soin: 'Bas du visage', prix: '80€ TTC', details: '' },
    { soin: 'Aisselles', prix: '60€ TTC', details: '' },
    { soin: 'Maillot simple', prix: '50€ TTC', details: '' },
    { soin: 'Maillot échancré', prix: '70€ TTC', details: '' },
    { soin: 'Maillot semi intégral', prix: '80€ TTC', details: '' },
    { soin: 'Maillot intégral', prix: '90€ TTC', details: '' },
    { soin: 'Cuisses', prix: '150€ TTC', details: '' },
    { soin: 'Demi jambes', prix: '130€ TTC', details: '' },
    { soin: 'Jambes complètes', prix: '180€ TTC', details: '' },
    { soin: 'Demi bras', prix: '60€ TTC', details: '' },
    { soin: 'Bras entier', prix: '100€ TTC', details: '' },
    { soin: 'Petites zones', prix: '60€ TTC', details: '' },
    { soin: 'Forfait Demi jambes + maillot + aisselles', prix: '240€ TTC', details: '' },
    { soin: 'Forfait Jambes complètes + maillot + aisselles', prix: '300€ TTC', details: '' },
  ]},
];
